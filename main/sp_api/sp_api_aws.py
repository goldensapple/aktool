...
# request_parameters = 'MarketplaceId=A1VC38T7YXB528&ItemCondition=New'
...
def sp_api_start():
    ...
    access_key = 'AKIARB5KAK2FV6FA4UD5'
    secret_key = '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'
    ...
    # canonical_uri = '/products/pricing/v0/items/B075TXTJ7P/offers' 
    canonical_uri = '/catalog/v0/items/B00AQACJD0' 
    ...
    canonical_querystring = urllib.parse.urlencode(request_parameters_unencode)
